...
1. 全局重点第一句写当日最重要国家和事件类型；第二句把最关键数据放进利多/利空对比；第三句写国际糖价主要矛盾，未确认 ICE 原糖持续站上 `15美分/磅` 时只写“震荡”。
...
3. 进口税、配额、关税新闻必须写政策状态和传导路径。印度评估削减或取消 `100%` 食糖进口税时，应写“仍在评估；若落地会降低进口成本、增加国内可用糖源、压制印度现货糖价”。
...
6. 甘蔗面积新闻必须同时比较去年同期和正常面积。印度甘蔗面积 `5831万公顷` 低于去年 `5862万公顷`、但高于正常 `5420万公顷`，且地区增减分化时，判断为中性；不能只写“58.31 lakh”或“方向不明”。
