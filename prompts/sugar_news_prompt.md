...
印度新闻必须纳入糖业间接影响识别：标题没有 `sugar` 但正文涉及 E20、乙醇掺混比例、油销公司乙醇采购、玉米/碎米等粮食乙醇、甘蔗汁、糖浆、B 重糖蜜、C 重糖蜜或制醇原料替代时，仍须作为印度糖业候选新闻核验。不得因其位于能源、石油或燃料政策栏目就排除；影响判断必须写清具体原料和方向，例如甘蔗汁、B 重糖蜜或糖浆进入乙醇装置会减少可结晶成糖的蔗糖量，C 重糖蜜制醇主要影响副产品变现，粮食乙醇增加会替代甘蔗体系制醇需求。不得写“改变甘蔗、糖蜜或糖浆在制糖和制醇之间的分配”这类泛化句，也不得在正文写“事件归属为”“公开标题显示”等内部流程语言。
...
完成泰国普通糖业新闻检索后，必须单独执行“泰国主要甘蔗产区降雨检查”，不能只依赖普通新闻搜索。每天至少检查最近一个完整自然日降雨实况、当日天气、未来 7 天降雨预报、降雨是否增加、强降雨或暴雨预警，以及连续少雨、高温或干旱风险。

优先使用泰国气象局官方日预报：https://tmd.go.th/en/forecast/daily。若官方只提供区域性信息，可用公开天气预报补充具体主产区，但必须保留来源链接，不得自行估算降雨量或降雨概率。检索不能只搜索 `Thailand weather`，必须把上述府名与 `rain`、`rainfall`、`thunderstorm`、`heavy rain`、`monsoon`、`drought` 等天气词组合检查。

只要泰国主要甘蔗产区存在有效降雨预报，泰国栏目必须增加一条天气信息；即使没有媒体新闻报道，也不得遗漏。同一天相同天气过程合并为一条，摘要用 2-3 句说明涉及产区、预报时间、降雨概率或雨量（来源提供时才写）、降雨类型，以及对甘蔗生长和糖价的影响。

整理泰国天气新闻时必须确认具体府名、是否为主产区、甘蔗生长阶段、降雨强度和实际影响。生长阶段不得仅凭“强降雨预报”推断甘蔗受灾，只有新闻明确指出严重洪涝、甘蔗倒伏、农田被淹、作物受损或预计减产时，才根据实际损失重新判断。

泰国天气影响判断：

- 甘蔗生长阶段，主产区出现强降雨、大雨、雷阵雨、阵雨、预报大雨、预报强降雨、预报雷阵雨、降雨范围扩大、降雨概率提高、未来降雨量增加、连续降雨，或降雨缓解干旱、改善土壤墒情：利空：甘蔗生长阶段的降雨有利于补充土壤水分、改善墒情并促进甘蔗生长和单产形成，从而增加未来甘蔗及食糖供应预期，因此利空糖价。
...
如果泰国东北部和中部主要甘蔗产区在甘蔗生长阶段出现降雨增加、强降雨预报、雷阵雨、阵雨、大雨或降雨范围/强度扩大，且未明确发生作物损失，影响统一写为：利空：甘蔗生长阶段的降雨有利于补充土壤水分、改善墒情并促进甘蔗生长和单产形成，从而增加未来甘蔗及食糖供应预期，因此利空糖价。不得再添加弱化判断。
...
产量、库存、销量或消费类供需新闻必须写清具体指标、统计截止期、方向和数值，不得写“关键数据包括”或“产量、库存、销量或消费变化会直接改变食糖供需平衡”。例如应写“截至7月12日糖产量下降10.98%至185万吨”。影响判断必须按指标和方向说明供需路径：产量下降减少当期新增可售糖源；库存下降削弱现货供应缓冲；销量或消费增加加快需求端消化；产量或库存增加提高可用糖源并形成供应压力；销量或消费下降或增速放缓削弱需求支撑。
